        ...
        <div class="row">
          <div class="col-sm-4 col-xs-12">
            <div class="teachersPhoto">
                <img class="img-rounded img-responsive" src="<?=$student_img->get_teacher_img_url($prof['sid']);?>">
            </div>
          </div>
          <div class="col-sm-8 col-xs-12">
            <div class="teachersInfo">
              ...
              <div class="professionDetails"><?php echo $prof['firstname'];?></div>
              <div class="teachersProfession bg-color-2">Nickname</div>
              <div class="professionDetails"><?php echo $prof['nickname'];?></div>
              <div class="teachersProfession bg-color-3">Room</div>
              <div class="professionDetails"><?php echo $prof['room'];?></div>
                <div class="teachersProfession bg-color-4">Educational</div>
                <div class="professionDetails" style="height: 100%"><?php echo $prof['education'];?></div>
                <div class="teachersProfession bg-color-5">Telephon number</div>
                <div class="professionDetails"><?php echo $prof['telno'];?></div>
